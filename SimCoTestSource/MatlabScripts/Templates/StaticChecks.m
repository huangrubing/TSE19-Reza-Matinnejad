            ...
            if(isempty(value))
              ...
              if(constName(1)=='K')
                ...
                if(strcmp(constName(1:2),'Kt'))
                  ...
                  if(eval(sprintf('size(%s.Value,1)',constName))==eval(sprintf('size(unique(%s.Value),1)',constName))&&eval(sprintf('size(%s.Value,2)',constName))==eval(sprintf('size(unique(%s.Value),2)',constName)))
